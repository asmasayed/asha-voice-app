    ...
    return (
        <div className="page-content schemes-page card">
            ...
            {isOnline ? (
                ...
                <>
                    <p className="text-gray-600 mb-4">📶 You are offline. Type your scheme question below:</p>
                    
                    {/* Offline Text Input */}
                    <div className="offline-container mb-6">
                        <textarea
                            ...
                            style={{ width: '100%', padding: '12px', border: '2px solid #2ecc71', borderRadius: '8px', fontSize: '16px' }}
                        />
                        <button 
                            className="btn btn-primary" 
                            onClick={() => handleOfflineTextSearch(schemeQuery)}
                            style={{ marginTop: '10px', width: '100%', backgroundColor: '#2ecc71', color: 'white', padding: '12px' }}
                        >
                            Search Schemes
                        </button>
                    </div>
